...
// Source: api/helloworld/v1/greeter_grpc.pb.go
...
func (m *MockGreeterClient) SayHello(ctx context.Context, in *v1.HelloRequest, opts ...grpc.CallOption) (*v1.HelloReply, error) {
	m.ctrl.T.Helper()
...
// SayHello mocks base method.
func (m *MockGreeterServer) SayHello(arg0 context.Context, arg1 *v1.HelloRequest) (*v1.HelloReply, error) {
	m.ctrl.T.Helper()
