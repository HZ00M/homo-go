...
const file_helloworld_v1_demo_proto_rawDesc = "" +
	"\n" +
	"\x18helloworld/v1/demo.proto\x12\x11api.helloworld.v1\"'\n" +
	...
	"\rListDemoReply2\xaf\x03\n" +
	"\x04Demo\x12V\n" +
	"\n" +
	"CreateDemo\x12$.api.helloworld.v1.CreateDemoRequest\x1a\".api.helloworld.v1.CreateDemoReply\x12V\n" +
	"\n" +
	"UpdateDemo\x12$.api.helloworld.v1.UpdateDemoRequest\x1a\".api.helloworld.v1.UpdateDemoReply\x12V\n" +
	"\n" +
	"DeleteDemo\x12$.api.helloworld.v1.DeleteDemoRequest\x1a\".api.helloworld.v1.DeleteDemoReply\x12M\n" +
	"\aGetDemo\x12!.api.helloworld.v1.GetDemoRequest\x1a\x1f.api.helloworld.v1.GetDemoReply\x12P\n" +
	"\bListDemo\x12\".api.helloworld.v1.ListDemoRequest\x1a .api.helloworld.v1.ListDemoReplyB6\n" +
